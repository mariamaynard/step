...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void optionalCAllDayMeeting() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times. There is also an optional attendee who has an all day event
    // Optional: |--------------C--------------|
    // Events  :       |--A--|     |--B--|
    // Day     : |-----------------------------|
    // Options : |--1--|     |--2--|     |--3--|
   ...
   @Test
  public void optionalCMiddayMeeting() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times. There is also an optional attendee.
    // Optional:             |--C--|
    // Events  :       |--A--|     |--B--|
    // Day     : |-----------------------------|
    // Options : |--1--|                 |--3--|
  ...
  public void justEnoughRoomOptional() {
    // Have one person, but make it so that there is just enough room at one point in the day to
    // have the meeting. Optional with a conflicting meeting so they get ignored.
    //            
    // Events  : |--A--|     |----A----|
    // Day     : |---------------------|
    // Options :       |-----|
  ...
  @Test
  public void optionalWithMeeting() {
    // two people that are both optional who have open times to have a meeting
    // Events  : |--A--|     |----B----|
    // Day     : |---------------------|
    // Options :       |-----|
    Collection<Event> events = Arrays.asList(
  ...
  @Test
  public void optionalWithoutMeeting() {
    // two people that are both optional who have open times to have a meeting
    // Events  : |--A--||----B---------|
    // Day     : |---------------------|
    // Options :       |-----|
